...
namespace SchoolSupport.Data
{
    public class Repository : IRepository, IDisposable
    {
        private bool disposed = false;
        public School_SupportEntities context;

        public Repository() : this(new School_SupportEntities()) { }

        public Repository(School_SupportEntities _context)
        {
            context = _context;
        }
        ...
        public async Task<ICollection<E>> GetAsyncBy<E>(Expression<Func<E, bool>> match) where E : class
        {
            try
            {
